...
import tutorial.DMAexample.MyBlocks.DiamondGlass;
...
public class MyCode {
	...
	public static Item adLaserGun;
	
	//components
	public static Item SteelIngot;
	public static Item titaniumIngot;
	public static Item battery;
	public static Item adBattery;
	...
	public static void MyBlocks(){
		...
		.setBlockTextureName("yourmodsname:siliconOre");
		 ...
		 diamondGlass = new DiamondGlass(Material.glass)
		.setHardness(8.0F)
		.setStepSound(Block.soundTypeGlass)
		.setBlockName("diamondGlass")
		.setCreativeTab(CreativeTabs.tabBlock)
		.setBlockTextureName("yourmodsname:diamondGlass");
		...
		//HarderenedDirt
		 ...
		 GameRegistry.registerBlock(diamondGlass, "DiamondGlass");
	...
	public static void MyItems()
	{
		...
		GameRegistry.registerItem(MyLauncher, "MyLauncher");
		 ...
		 adBattery = new BaseItem()
		 .setMaxStackSize(64)
		 .setUnlocalizedName("adBattery")
		 .setTextureName("yourmodsname:adBattery")
		 .setCreativeTab(CreativeTabs.tabMaterials);
		 GameRegistry.registerItem(adBattery, "AdBattery");
		...
		adLaserGun = new LaserGun()
			.setUnlocalizedName("AdLaserGun")
			.setTextureName("yourmodsname:adLaserGun")
			.setCreativeTab(CreativeTabs.tabCombat);
			GameRegistry.registerItem(adLaserGun, "AdLaserGun");
...
//		 });
		 ...
		 //Misc.
		 GameRegistry.addRecipe(new ItemStack(laserGun), new Object[] {
			"AAA",
			"BAC",
			"AAC",
			'A', titaniumIngot,
		 ...
		 GameRegistry.addRecipe(new ItemStack(adLaserGun), new Object[] {
			 "DEC",
			 "ABC",
			 "DEC",
			 'A', diamondGlass,
		 ...
		 GameRegistry.addRecipe(new ItemStack(adProcessor), new Object[] {
			 "ABA",
			 "BCB",
			 "ABA",
